...
<details>
  ...
  <h4>The chart below contains the percent of the total population receiving first doses. Note that this includes Federal doses administered (see discussion at the top of this page).</h4>
```{r message=FALSE, warning=FALSE}
...
<details>
  ...
  <h4>The chart below contains the percent of the total population fully vaccinated (two doses for Pfizer and Moderna, one dose for J&J, etc.). Note that this includes Federal doses administered (see discussion at the top of this page).</h4>
```{r message=FALSE, warning=FALSE}
